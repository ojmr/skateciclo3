...
function autoInicioMensajes(){
    ...
    $.ajax({
       url:"http://129.159.57.27:80/api/Message/all",
...
function pintarRespuestaMensajes(respuesta){
    ...
    myTable+="</table>";
    $("#miResultadoMensaje").html(myTable);
}
...
function guardarInformacionMensajes(){
    ...
    let var2 = {
        ...
        url:"http://129.159.57.27:80/api/Message/save",
...
function actualizarInformacionMensaje(idElemento){
    ...
    $.ajax({
        url:"http://129.159.57.27:80/api/Message/update",
...
function borrarMensaje(idElemento){
    ...
    $.ajax({
        url:"http://129.159.57.27:80/api/Message/"+idElemento,
