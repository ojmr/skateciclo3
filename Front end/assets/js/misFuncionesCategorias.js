...
function pintarRespuestaCategoria(respuesta){
    ...
    myTable+="</table>";
    $("#miResultadoCategoria").html(myTable);
}
...
function guardarInformacionCategorias(){
    ...
    let var2 = {
        ...
        url:"http://129.159.57.27:80/api/Category/save",
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://129.159.57.27:80/api/Category/update",
...
function borrarCategoria(idElemento){
    ...
    $.ajax({
        url:"http://129.159.57.27:80/api/Category/"+idElemento,
