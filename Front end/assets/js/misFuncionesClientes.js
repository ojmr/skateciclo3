...
function pintarRespuestaCliente(respuesta){
    ...
    myTable+="</table>";
    $("#miResultadoClientes").html(myTable);
}
...
function guardarInformacionCliente(){
    let var2 = {
        ...
        url:"http://129.159.57.27:80/api/Client/save",
...
function actualizarInformacionCliente(idElemento){
    ...
    $.ajax({
        url:"http://129.159.57.27:80/api/Client/update",
...
function borrarCliente(idElemento){
    ...
    $.ajax({
        url:"http://129.159.57.27:80/api/Client/"+idElemento,
